    ...
    campaignAdSets.forEach((adSet) => {
      ...
      adSetAds.forEach((ad) => {
        ...
        ads.push({
          ...
          reviewStatus: ad.reviewStatus || details.reviewStatus || null,
          rejectionReason: ad.rejectionReason || details.rejectionReason || '',
          adReviewFeedback: ad.adReviewFeedback || details.adReviewFeedback || null,
...
const AdDetailsModal = ({ ad, context, onClose }) => {
  ...
  const details = [
    ...
    ['Review Status', getDeliveryStatusLabel(ad.reviewStatus)],
